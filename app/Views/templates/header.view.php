        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="/notas-alumno" class="nav-link <?php echo isset($seccion) && $seccion === 'notas-alumno' ? 'active' : ''; ?>">
                  <i class="fas fa-cube nav-icon"></i>
                  <p>Notas Alumno</p>
                </a>
              </li>
                ...
                <li class="nav-item">
                <a href="/notas2" class="nav-link <?php echo isset($seccion) && $seccion === 'notas2' ? 'active' : ''; ?>">
              ...
              <li class="nav-item">
                <a href="/conexion" class="nav-link <?php echo isset($seccion) && $seccion === 'conexion' ? 'active' : ''; ?>">
                  <i class="fas fa-bars nav-icon"></i>
                  <p>Probar Conexion</p>
                </a>
              </li>
